...
<Frame caption="Automations home page">
  ![Captain Labs homepage showing Automation setup](/images/automationtriggers1.jpg)
</Frame>
...
<Frame caption="Automation Triggers in SalesCaptain">
  ![New automation screen showing types of available triggers ](/images/automationtriggersmain.jpg)
</Frame>
...
<Frame caption="SalesCaptain automation triggers">
  ![Popup showing all available SalesCaptain triggers for automation](/images/automationtriggers.jpg)
</Frame>
...
<Frame caption="External automation triggers">
  ![Popup showing all available external triggers for automation](/images/automationtriggers4.jpg)
</Frame>
...
3. Configure the webhook:
   ...
   - Copy the **generated URL** and share it with the external system.
     ...
     <Frame caption="Webhook URL generation ">
       ![automation triggers 5.jpg](/images/automationtriggers5.jpg)
     </Frame>
...
<Frame caption="Webhook trigger on the canvas">
  ![Canvas view showing Webhook trigger in SalesCaptain automation builder](/images/automationtriggers6.jpg)
</Frame>
...
<Frame caption="CSV upload configuration ">
  ![Popup showing CSV upload configuration options for triggering an automation](/images/automationtriggers7.jpg)
</Frame>
