...
Move the call to another user, hardphone, group, or contact. Choose between a **direct transfer** (send the call immediately) or a **warm transfer** (speak to the recipient first).
