---
title: "Making Calls"
description: "With SalesCaptain’s desktop application, you can reach customers directly from anywhere in the platform. Whether you’re inside the unified inbox, using the call bar, or browsing recent history, starting a call only takes a click.
Outgoing calls can also be made from the SalesCaptain mobile app, as well as SIP phones connected to SalesCaptain. "
---
...
![Unifiedinbox1 Final Jp](/images/unifiedinbox1_final.jpg)
...
![Callbar1 Final Jp](/AnyConv.com__callbar1_final.webp)
...
![Recentcall1 Jp](/images/recentcall1.jpg)
...
Before placing outgoing calls, we suggest you <u>import your contacts</u> into SalesCaptain, and set up your [incoming call flow,](/Core-Features/Calls/Call-Flows/Creating-Call-Flows) so you never miss a beat.
