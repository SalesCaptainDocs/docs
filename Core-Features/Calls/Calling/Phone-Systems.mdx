...
<Frame caption="Mobile app configuration">
  <img
    src="/images/phonesystem1.webp"
    alt="SalesCaptain Mobile app menu screen "
    title=""
    style={{ width:"100%" }}
  />
</Frame>
...
<Frame caption="Security Settings for Yealink Deskphones">
  ![Yealink Deskphones security settings for SalesCaptain](/images/phonesystem2.webp)
</Frame>
...
Here's an example of what this page would look like with all the fields filled in correctly:

<Frame caption="SIP Account registration form">
  ![Yealink Deskphones SIP Account Registration Form for SalesCaptain](/images/phonesystem3.webp)
</Frame>
