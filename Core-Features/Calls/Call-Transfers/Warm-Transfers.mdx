...
Looking for the fastest way to move a caller without speaking to the recipient first? Check out our Direct Transfers guide instead.
...
[Insert image: Warm transfer selection screen]Once the recipient confirms they’re ready, you can complete the transfer with a single click. If needed, you can also add a quick note so the recipient sees context immediately.

[Insert image: Warm transfer in progress / add note]## **When to Use Warm Transfers**
