...
Need to brief the recipient before handing the call off? See our [Warm Transfers](Core-Features/Calls/Call-Transfers/Warm-Transfers) guide for that option.
