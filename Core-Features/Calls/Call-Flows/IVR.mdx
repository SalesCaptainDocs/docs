...
1. In the **Call Flows** editor, drag the **IVR Menu** element from the right-hand panel into your workspace_._
...
By using IVR menus in your call flows, you give customers a clear path to the right person or information while freeing your team from unnecessary transfers.