...
By using IVR menus in your call flows, you give customers a clear path to the right person or information while freeing your team from unnecessary transfers. Visit our step-by-step breakdown on setting up [call flows](Core-Features/Calls/Call-Flows/Creating-Call-Flows) in SalesCaptain.