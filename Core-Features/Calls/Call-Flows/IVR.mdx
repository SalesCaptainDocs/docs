...
1. In the **Call Flows** editor, drag the **IVR Menu** element from the right-hand panel into your workspace.
   ...
   <Frame caption="Call flow builder with IVR ">
     <img
       src="/images/AnyConv.com__callbar8.webp"
       alt="Canvas overview with IVR in SalesCaptain call flow builder "
       title=""
       style={{ width:"100%" }}
     />
   </Frame>
2. Add a greeting or menu prompt. For example: “Press 1 for Sales, Press 2 for Support.” You can upload a prerecorded message or type text for our text-to-speech engine.
   ...
   <Frame caption="Configure IVR options">
     ![IVR configuration options in SalesCaptain call flow builder ](/images/addingivr2.webp)
   </Frame>
...
<Frame caption="Example incoming call flow ">
  ![Example incoming Call Flow in SalesCaptain ](/images/addingivr3.webp)
</Frame>
