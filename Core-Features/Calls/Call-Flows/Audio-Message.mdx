...
- Can communicate useful info (e.g. “We may record this call”, “Due to high volume there may be a wait”, etc.).
...
- Keep audio messages short and focused. Overlong messages can frustrate callers.
- Use high quality audio (for MP3 versions). If using text-to-speech, test for clarity.
...
- Test the audio branches in your flow, including transitions following the message.