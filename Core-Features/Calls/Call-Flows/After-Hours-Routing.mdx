...
5. **Test the flow**: Save and activate. Simulate calls during in-hours and after-hours to confirm everything works as expected. Visit our step-by-step breakdown on setting up [call flows](Core-Features/Calls/Call-Flows/Creating-Call-Flows) in SalesCaptain.
