...
<Steps>
  <Step title="General ">
    1. Customize the subject line and email signature text for your feedback request email.
  </Step>
  <Step title="CX Rating Page">
    1. Create a rating page that can be customized with **NPS scores**, **star ratings**, or **emoji-based feedback formats**.
  </Step>
