...
<Frame>![call 1.webp](/images/call1.webp)</Frame>
...
<Frame>![call 2.webp](/images/call2.webp)</Frame>

### **Assigning Key Inputs (DTMF)**

Upon enabling response capture, you may define what happens when a customer presses each key during the call.
...
Templates can be attached to **marketing campaigns** or triggered alongside **emails and SMS** from the [unified inbox](/Core-Features/Messaging-and-Inbox/Inbox/Inbox-Overview) for seamless multi-channel communication.
