...
1. Go to the **Contacts** tab and select **Options** before clicking on **Upload CSV**.
   ...
   <Frame>![Importingcontacts Web](/images/importingcontacts.webp)</Frame>
2. Upload your CSV file.

  <Frame> ![Upload CSV Web](/images/uploadCSV.webp)</Frame>
3. Map your column headers to the correct SalesCaptain fields (Name, Number, Email, etc.).
4. If your file contains unique data, you can \*\*create new custom fields on the spot. \*\*Learn more about [managing custom fields](Custom-Fields).
5. Review your mapping and click **Import**.

  <Frame>![Mappinginformation Web](/images/mappinginformation.webp)</Frame>
...
<Frame>![Finalcontacts Web](/images/finalcontacts.webp)</Frame></Frame>
