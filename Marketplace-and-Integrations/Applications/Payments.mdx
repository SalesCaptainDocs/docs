...
- Before sending your first payment request, double-check that your gateway (Helcim, Stripe, or [Authorize.net](http://Authorize.net)) is correctly connected and verified.
