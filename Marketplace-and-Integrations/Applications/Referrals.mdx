...
📸 _Placeholder: Screenshot of Referrals app in the SalesCaptain Marketplace_
...
You can build templates for **<u>SMS</u>**<u> </u>or **<u>Email</u>**, depending on how you want to reach customers. The overall flow and content sections remain similar across both channels. Navigate to Marketing - Templates to begin building your custom referral request. 
...
📸 _Placeholder: Screenshot of General settings showing subject and signature fields_
...
📸 _Placeholder: Screenshot of Referral Request Text editor with example message for SMS and email_
...
📸 _Placeholder: Screenshot of Referral Page showing share options and unique referral link_
...
📸 _Placeholder: Screenshot comparing Text Referral Form and Email Referral Form layouts_
...
📸 _Placeholder: Screenshot of Thank You Page showing confirmation message_
...
📸 _Placeholder: Screenshot of Referrals tab showing Sent, Shared, and Received sections_
...
📸 _Placeholder: Screenshot of message composer showing the Referrals option with text/email toggle_
