...
You can create and manage these triggers inside **Captain Labs → Automations**.
...
For detailed information on the **available actions** and **flow controls** you can trigger, see our page: **Actions & Flow Controls**.